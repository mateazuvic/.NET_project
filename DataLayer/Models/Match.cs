...
namespace DataLayer.Models
{
    public class Match : IComparable<Match>
    {
        ...
        public override bool Equals(object obj) => obj is OpponentTeam other ? HomeTeam.Country == other.Country || AwayTeam.Country == other.Country : false;
       

        public override int GetHashCode() => AwayTeam.Country.GetHashCode();
